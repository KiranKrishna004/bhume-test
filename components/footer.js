        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          "
            >
              ...
              BhuME Women's Collective Pvt Ltd
            </h6>
            <p>
              A social enterprise that collects sanitizes and upcycles tailoring
              excesses generated in Kerala to use them as filling for soft toys
              which are cuddly and capable of serving educational needs.
            </p>
          </div>
          <div className="">
