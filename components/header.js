...
const Header = () => {
  return (
    <nav class="flex flex-wrap w-full items-center justify-between p-6">
      ...
      <div class="block lg:hidden">
        <button class="flex items-center rounded border border-teal-400 px-3 py-2 hover:border-white ">
          <svg
      ...
      <div class="block w-full flex-grow lg:flex lg:w-auto lg:items-center">
        {/* <div class="text-sm lg:flex-grow">
          <a
            ...
            class="mt-4 mr-4 block hover:text-white lg:mt-0 lg:inline-block"
          >
            Docs
          </a>
          <a
          ...
          <a
            href="#responsive-header"
            class="mt-4 block hover:text-white lg:mt-0 lg:inline-block"
          >
            Blog
          </a>
        </div> */}
